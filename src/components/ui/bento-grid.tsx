...
const BentoCard = ({
    ...
    <div
        ...
        className={cn(
            ...
            "bg-background shadow-[0_24px_70px_-24px_rgba(15,23,42,0.15)]",
            className,
        )}
    >
        <div>{background}</div>
        <div className="pointer-events-none z-10 flex flex-col gap-1 p-6 transition-all duration-300 group-hover:-translate-y-10">
            <Icon className="h-12 w-12 origin-left text-violet-500 transition-all duration-300 ease-in-out group-hover:scale-75" />
